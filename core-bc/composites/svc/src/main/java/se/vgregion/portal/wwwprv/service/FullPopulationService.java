 ...
 */
public class FullPopulationService {
     ...
     * @return se above...
     */
    public LookupResidentForFullProfileResponseType lookup(String... bySocialSecurityNumbers) {
     ...
     * units that takes responsibility for the area where the person lives.
     */
    public List<ResidentType> lookup(Arg... bySocialSecurityNumbersAndStringDates) {
        List<ResidentType> result = new ArrayList<>();
        for (Arg arg : bySocialSecurityNumbersAndStringDates) {
            ...
            LookupResidentForFullProfileType callArg = new LookupResidentForFullProfileType();
            LookUpSpecificationType spec = new LookUpSpecificationType();
